...
Use the record_extraction tool to record your structured extraction.`;
  ...
  return [
    {
      ...
      content: [
        {
          type: "text",
          text: `Extract structured clinical data from the following transcript. Keep every extracted value grounded in the transcript text:\n\n${transcript}`,
        },
      ],
    },
  ];
